...
/** The amount of buffer space next to labels for clarity purposes */	
	public static final int LABEL_SPACE = 3;

/** The number of different colors used to graph entries */
